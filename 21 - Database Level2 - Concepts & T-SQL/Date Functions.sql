...
SELECT DATEADD(Month, 10, GETDATE()) AS DatePlus10Month
GO

SELECT DATEADD(Year, 10, GETDATE()) AS DatePlus10Years
GO
...
SELECT DATEDIFF(MONTH, '2023-01-01', GETDATE()) AS MonthSinceStartOfYear
GO

SELECT DATEDIFF(YEAR, '2023-01-01', GETDATE()) AS YearsSinceStartOfYear
GO
