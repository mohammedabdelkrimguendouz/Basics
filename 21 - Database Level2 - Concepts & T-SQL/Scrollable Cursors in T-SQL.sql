...
BEGIN
    ...
    PRINT 'Student ID :  '+cast(@StudentID as varchar)+' , Student Name: ' + @Name + ' , Grade: ' + CAST(@Grade AS NVARCHAR(10));
...
-- Fetch the last row of data from the cursor and store it in the declared variables.
